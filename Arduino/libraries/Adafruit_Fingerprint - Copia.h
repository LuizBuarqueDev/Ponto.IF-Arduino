...
#define FINGERPRINT_UPCHAR     0x08  // comando para exportar template
#define FINGERPRINT_DOWNCHAR   0x09  // comando para importar template
...
class Adafruit_Fingerprint {
 public:
  ...
  int downloadModel(uint8_t *templateBuffer, uint16_t buffSize = 512);
  int uploadModel(uint8_t *templateBuffer, uint16_t buffSize = 512);
